...
exports.recordRunStart = recordRunStart;
exports.recordRunEnd = recordRunEnd;
exports.upsertNormalized = upsertNormalized;
const db_1 = require("./db");
async function recordRunStart(run) {
...
async function recordRunEnd(runId, status, finishedAt, processed, errors) {
    const client = await (0, db_1.getClient)();
    await client.query(`
...
async function upsertNormalized(rec) {
    const client = await (0, db_1.getClient)();
    await client.query(`
